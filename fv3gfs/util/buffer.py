...
class Buffer:
    ...
    def __init__(self, key: BufferKey, array: np.ndarray):
        ...
        Args:
            key: a cache key made out of tuple of allocator (behaving like np.empty or np.zeros), shape and dtype
    ...
    def pop_from_cache(
        ...
        Args:
            allocator: behaves like a np.empty or np.zeros function, used to allocate memory
...
def send_buffer(
    ...
    Args:
        allocator: a function behaving like numpy.empty or numpy.zeros
